...
{
    public class StateMachineViewModel : VFlowObservableObject
    {
        public StateMachineViewModel()
        {
            ...
            {
                Actions = new VFlowObservableCollection<BlackboardItemReferenceViewModel>(BlackboardDescriptor.GetAvailableItems<IBlackboardAction>()),
                Conditions = new VFlowObservableCollection<BlackboardItemReferenceViewModel>(BlackboardDescriptor.GetAvailableItems<IBlackboardCondition>())
            };
        ...
        private VFlowObservableCollection<StateViewModel> _states = new VFlowObservableCollection<StateViewModel>();
        public VFlowObservableCollection<StateViewModel> States
        {
            get => _states;
            set => SetProperty(ref _states, value);
        }

        private VFlowObservableCollection<StateViewModel> _selectedStates = new VFlowObservableCollection<StateViewModel>();
        public VFlowObservableCollection<StateViewModel> SelectedStates
        {
            get => _selectedStates;
            set => SetProperty(ref _selectedStates, value);
        }

        private VFlowObservableCollection<TransitionViewModel> _connections = new VFlowObservableCollection<TransitionViewModel>();
        public VFlowObservableCollection<TransitionViewModel> Transitions
        {
            get => _connections;
